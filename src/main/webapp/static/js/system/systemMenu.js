$(function () {
    $('#systemMenu_treegrid').treegrid({
        ...
        columns:[[
            ...
            {field:'text',title:'菜单名字',width:60},
            {field:'url',title:'菜单路径',width:60},
            {field:'parent.name',title:'父级菜单',width:60},
        ]]
    });

})
/*$(function () {
    $.post('/systemMenu/data',{id:123},function(data){
        $('#systemMenu_treegrid').treegrid('loadData',data);
    },'json');
})*/
