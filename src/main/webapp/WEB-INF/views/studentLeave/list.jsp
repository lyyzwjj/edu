...
<head>
    ...
    <script src="../../../static/js/system/studentLeave.js"></script>
</head>
<body>
<table id="studentLeave_datagrid" fit="true"></table>
<div id="tb">
    ...
    流失时间:<input type="text" id="begindate" class="easyui-datebox" name="begindate" prompt="起始时间">~
    ...
    <form id="editForm" method="post" style="padding: 0px 0px 0px 10px;">
        ...
        <table style="border-collapse:separate; border-spacing:10px;">
            <tr>
                ...
                <td>
                    <input id="studentLeave_combogrid" name="receiptbill.id"/>
                </td>
            </tr>
            <tr>
