...
<div id="client_dialog">
    <form id="editForm" method="post" style="padding: 40px 0px 0px 30px;">
        ...
        <table style="border-collapse:separate; border-spacing:10px;">
            ...
            <tr>
                <td><font size="1">跟踪人员:</font></td>
                <td><input class="easyui-textbox" type="text" name="inputMan.id"/></td>
            </tr>
            <tr>
                <td><font size="1">跟踪次数:</font></td>
                <td><input class="easyui-textbox" type="text" name="traceTimes"/></td>
            </tr>
            <tr>
                <td><font size="1">最后跟踪时间:</font></td>
                <td><input class="easyui-datebox" type="text" name="lastTraceDate"/></td>
            </tr>
            <tr>
